...
document.addEventListener('DOMContentLoaded', function() {
  // Only add linkable headings on post and page templates, not on home/index pages
  const body = document.body;
  if (body.classList.contains('home') || body.classList.contains('index') || 
      document.querySelector('.post-list') || document.querySelector('.main-nav-cards')) {
    return; // Exit early if on homepage or index page
  }
